...
def queues_create():
	"""
	Create queue
	curl -X POST -H 'Content-Type: application/json' http://localhost:5000/queues -d '{"name": ""}'
	curl -X POST -H 'Content-Type: application/json' 52.18.184.96:8080/queues -d '{"name": "	
...
def queues_remove(name):
	"""
	Delete queue
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/qu
	curl -X DELETE -H 'Accept: application/json' 52.18.184.96:8080/queues
...
def messages_count(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/msgs/count
	curl -X GET -H 'Accept: application/json' 52.18.184.96:8080/queues/msgs/count
	"""
...
def messages_write(name):
	...
	curl -s -X POST -H 'Accept: application/json' http://localhost:5000/queues/msgs -d '{"content": "this is the queue message"}' 
	curl -s -X POST -H 'Accept: application/json' 52.18.184.96:8080/queues/msgs -d '{"content": "this is the queue message"}'
	"""
...
def messages_read(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:5000/queues/msgs
	curl -X GET -H 'Accept: application/json' 52.18.184.96:8080/queues/msgs
	"""
...
def messages_consume(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queue/sgs
	curl -X DELETE -H 'Accept: application/json' 52.18.184.96:8080/queues/sgs
	"""
